 ...
 * @since 2.6.0
 */
define( 'AUTH_KEY',         '6PfS-)dpbC{O SSK3RAY0=R^_==il%dTM%(,@*u/@Pf1E]Y(7fUbW}6zg}D0kPI~' );
define( 'SECURE_AUTH_KEY',  'aB~A|*y&.qld{.1O/|G~ibbDuK=9KQh<B&(f06>)/~8ho?^}T@7~MEmX1BBY[h|R' );
define( 'LOGGED_IN_KEY',    '9nGI24|J^l/J_;48]$(txrPhu9;2lX#,{z6`G%JUjsw{y$JOZ(chsS.m[YHxiswH' );
define( 'NONCE_KEY',        ':+QQJzE$@P~YZSzy=~eGuhMzOC&l6n);[ZYO-38#!9/99C_4jB&k&s5-Ol8xQ7] ' );
define( 'AUTH_SALT',        'FDBx?qsO_qtcLNs?gDw}%sYm8Z/3{P9oq-jc.?%NFPk%&54Bvg/&!%Nt>W@~I>:y' );
define( 'SECURE_AUTH_SALT', 'sn(<7*{RfM.D~^z:v3KPh6VCS/$1+J^[eEYAZ#P}v|Oc:Ndn=xMr(_Hkw< NNJS3' );
define( 'LOGGED_IN_SALT',   'TWb!=wouHZpd&cN&Rw{WjnSL/m9q9w##@Q<NP5}WU+;!HlR-_]NmdU0/ZjjuUQEE' );
define( 'NONCE_SALT',       '!bn`D[.[Pv>@jkN&1j~:}/2{Tv:6y@E]4S225S7-ZwTbMEX10hEuG7QxQp+Q@5U#' );
